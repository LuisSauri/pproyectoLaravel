...
<?php $__env->startSection('title', 'Alumnos | Escuela de Música'); ?>
            ...
            <table class="table table-hover table-striped table-responsive border m-2">
                <thead class="table table-dark col-xs">
                  <tr>
                    ...
                    <th scope="col" class="text-center">Historial de Pagos</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo e($alumno->id); ?> </td>
                        ...
                        <td class="text-center"></td>
                        <td class="">
                            <a href="<?php echo e(url('alumnos/'.$alumno->id.'/alumnosEdit')); ?>" class="btn btn small btn-warning"><i class="bi bi-pen-fill"></i></a>
